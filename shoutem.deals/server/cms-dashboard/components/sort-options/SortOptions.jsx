...
export function getAlwaysAvailableSortFormats() {
  return [
    { name: 'timeCreated', title: i18next.t('Created time') },
    { name: 'timeUpdated', title: i18next.t('Updated time') },
  ];
}
...
class SortOptions extends Component {
  ...
  render() {
    ...
    const displayFieldLabel = displayFieldTitle
      ? i18next.t('Sort by', { displayFieldTitle })
      : i18next.t('Select sort field');
