...
export function loadDeals(
  ...
  return loadResources(appId, [categoryId], types.DEALS, ext('deals'), filter, scope);
}
...
export function createDeal(appId, categoryIds, placeId, resource, scope = {}) {
  ...
  return createResource(appId, categoryIds, types.DEALS, resource, relatedResources, scope);
}
export function updateDeal(appId, categoryIds, placeId, resource, scope = {}) {
  ...
  return updateResource(appId, categoryIds, types.DEALS, resource, relatedResources, scope);
}
...
export function loadPlaces(appId, scope = {}) {
  ...
  return loadResources(appId, undefined, types.PLACES, ext('places'), filter, scope);
}
...
export function loadDealCategories(appId, parentCategoryId, scope = {}) {
  ...
  return loadCategories(appId, parentCategoryId, types.DEALS, ext('categories'), filter, scope);
}
