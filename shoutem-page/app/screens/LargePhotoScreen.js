...
export class LargePhotoScreen extends AboutScreen {
  static propTypes = {
  ...
  renderImage(profile, styleName) {
    return super.renderImage(profile, styleName || 'large-portrait');
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(
  connectStyle(ext('LargePhotoScreen'))(LargePhotoScreen),
);
