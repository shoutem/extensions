...
const FORM_WEBSITE_URL = `${key}.form-website-url`;
const FORM_WEBSITE_SETTINGS = `${key}.form-website-settings`;
const FORM_COOKIES_PERMISSIONS = `${key}.form-cookies-permissions`;
...
const FORM_SHOW_SCREEN_TITLE = `${key}.form-show-scree-title`;
