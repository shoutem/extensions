...
export function loadAvailableProducts() {
  return dispatch => Iaphub.getProductsForSale().then(products => {
    dispatch({
...
export function loadActiveProducts() {
  return dispatch => Iaphub.getActiveProducts().then(products => {
    dispatch({
...
export function buyProduct(productId) {
  return dispatch => Iaphub.buy(productId)
    .then(() => dispatch(loadProducts()))
}

export function restorePurchases() {
  return dispatch => Iaphub.restore()
    .then(() => dispatch(loadProducts()))
}
