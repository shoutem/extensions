...
function setSwiftVersion() {
  ...
  if (fs.existsSync(placeholderPath)) {
    console.log('[shoutem.advertising] - Dummy Swift file present at', placeholderPath, ' -skipping...');
    return;
  }

  console.log('[shoutem.advertising] - Creating dummy Swift file at', placeholderPath);
