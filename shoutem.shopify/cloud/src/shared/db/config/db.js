...
import fs from 'fs';
import { requireEnvString, requireEnvBoolean } from '../../../../core/env';
...
const config = {
  ...
  // disables the creation of default model values
  // createdAt / updatedAt. We're omitting this to avoid defining
  // same properties for every model
  define: {
    timestamps: false
  },
  operatorsAliases: {
