...
import { Metadata, PlaybackControl, TrackProgressBar } from '../components';
...
/**
 * Displays active audio track and metadata in absolutely positioned banner UI, making
 * interactions with active audio accessible from anywhere in the app. When pressed, opens audio
 * modal with more active audio information, such as metadata, controls, queue and audio settings.
 */
